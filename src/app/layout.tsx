...
export const metadata: Metadata = {
  ...
  description:
    'AI-powered girl dinner generator. Enter your ingredients and get a fancy name, plating blueprint, and vibe check for your chaotic snack spread.',
  ...
  openGraph: {
    title: 'CharcuterME - Turn Fridge Chaos Into Culinary Art',
    description:
      'AI-powered girl dinner generator. Enter your ingredients and get a fancy name, plating blueprint, and vibe check.',
    type: 'website',
